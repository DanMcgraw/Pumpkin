...
mod tests {
    ...
    fn protocol_1001_container_names_use_wire_order() {
        let expected = [
            (18, ContainerName::RecipeFood),
            (19, ContainerName::RecipeBlocks),
            (20, ContainerName::RecipeFurnaceItems),
            (32, ContainerName::Inventory),
            (37, ContainerName::Offhand),
            (62, ContainerName::Cursor),
            (66, ContainerName::Dynamic),
        ];
...
impl TryFrom<u8> for ContainerName {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            ...
            18 => Ok(Self::RecipeFood),
            19 => Ok(Self::RecipeBlocks),
            20 => Ok(Self::RecipeFurnaceItems),
            21 => Ok(Self::RecipeSearch),
            22 => Ok(Self::RecipeSearchBar),
            23 => Ok(Self::RecipeEquipment),
            24 => Ok(Self::RecipeBook),
            25 => Ok(Self::EnchantingInput),
            26 => Ok(Self::EnchantingMaterial),
            27 => Ok(Self::FurnaceFuel),
            28 => Ok(Self::FurnaceIngredient),
            29 => Ok(Self::FurnaceResult),
            30 => Ok(Self::HorseEquip),
            31 => Ok(Self::HotBar),
            32 => Ok(Self::Inventory),
            33 => Ok(Self::ShulkerBox),
            34 => Ok(Self::TradeIngredient1),
            35 => Ok(Self::TradeIngredient2),
            36 => Ok(Self::TradeResultPreview),
            37 => Ok(Self::Offhand),
            38 => Ok(Self::CompoundCreatorInput),
            39 => Ok(Self::CompoundCreatorOutputPreview),
            40 => Ok(Self::ElementConstructorOutputPreview),
            41 => Ok(Self::MaterialReducerInput),
            42 => Ok(Self::MaterialReducerOutput),
            43 => Ok(Self::LabTableInput),
            44 => Ok(Self::LoomInput),
            45 => Ok(Self::LoomDye),
            46 => Ok(Self::LoomMaterial),
            47 => Ok(Self::LoomResultPreview),
            48 => Ok(Self::BlastFurnaceIngredient),
            49 => Ok(Self::SmokerIngredient),
            50 => Ok(Self::Trade2Ingredient1),
            51 => Ok(Self::Trade2Ingredient2),
            52 => Ok(Self::Trade2ResultPreview),
            53 => Ok(Self::GrindstoneInput),
            54 => Ok(Self::GrindstoneAdditional),
            55 => Ok(Self::GrindstoneResultPreview),
            56 => Ok(Self::StonecutterInput),
            57 => Ok(Self::StonecutterResultPreview),
            58 => Ok(Self::CartographyInput),
            59 => Ok(Self::CartographyAdditional),
            60 => Ok(Self::CartographyResultPreview),
            61 => Ok(Self::Barrel),
            62 => Ok(Self::Cursor),
            63 => Ok(Self::CreatedOutput),
            64 => Ok(Self::SmithingTableTemplate),
            65 => Ok(Self::CrafterLevelEntity),
            66 => Ok(Self::Dynamic),
            _ => Err(Error::new(
